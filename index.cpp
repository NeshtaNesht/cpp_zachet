...
const int _MAX_VALUE_ = 10; // Максимальное значение рандомайзера
const int _EXCELLENT_ = 10; // Количество верных ответов на "отлично"
const int _GOOD_ = 8; // Количество верных ответов на "хорошо"
const int _SATISF_ = 5; // Количество верных ответов на "удовлетворительно"
...
int main() {
	...
	for(int i = 1; i <= _MAX_VALUE_; i++) {
		// Пройдемся по всем результатам и найдем совпадения
		for(int n : answers) {
		...
		// Добавляем результат в вектор результатов
